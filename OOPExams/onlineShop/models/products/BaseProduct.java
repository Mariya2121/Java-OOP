package OOPExams.onlineShop.models.products;
...
public abstract class BaseProduct implements Product {
    ...
    public String toString() {
        return String.format(OutputMessages.PRODUCT_TO_STRING, overallPerformance, price, this.getClass().getSimpleName(), manufacturer, model, id);
    }
}
