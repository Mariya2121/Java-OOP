...
public class ControllerImpl implements Controller {
    ...
    public String calculateKg(String areaName) {
        Area area = getArea(areaName);
        double totalKgInArea = area.getAnimals().stream().mapToDouble(Animal::getKg).sum();
        return String.format(ConstantMessages.KILOGRAMS_AREA, areaName, totalKgInArea);
    }
